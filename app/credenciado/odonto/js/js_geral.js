...

{
	...
	divToPrint.find("#title_print_cidade").text( "CIDADE: " + guia.giaCidade );
...

	{
		...
		var html = "<tr><td>"+uppercase(item.gapProcedimento)+"</td><td></td><td></td><td>"+uppercase(item.gapPrestador)+"</td><td>"+formatValorProc( item.gapValor )+"</td></tr>";
