<?php
  ...
  $arquivo = '
       <div class="main" style = "margin: auto; font-family: Arial; font-size: 16px; max-width: 500px; padding: 20px; min-width: 300px; border: 0px solid red;">
        ...
        <div class="corpo-mail" style = "width: 100%; margin-top: 20px; padding: 10px 0px; border-bottom: 0px solid #ccc; color: #909090;">
          <h1 style = "color: #2897cf">Ajude '.$nome.' à adquirir o plano Prover Odonto!</h1>
          <p style = "font-size: 18px;">
            '.$nome.' está com dúvida para comprar o plano odontológico Prover Odonto, esses são os dados dele(a):
          </p>
          <p style = "padding: 20px; margin: 10px; border-radius: 3px; background-color: #fafafa; border-left: 2px solid #2897cf;">
            ...
            <br><br>
            <span style = "color: #c1c1c1;">Interesse</span><br>
            <span style = "font-size: 20px; color: #707070;">'.$assunto.'</span>
            <br><br>
  ...
  $assunto = "[ Site Prover odonto | Fale com consultor ] ".$nome." solicitou um contato de um consultor";
    ...
    if(mail($destino, $assunto, $arquivo, $headers)){
      echo '
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            Em breve um consultor entrará em contato com você. Fique atendo no telefone que você informou.
