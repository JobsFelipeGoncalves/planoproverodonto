<?php
  ...
  function deixarNumero($string){
    ...
    //geração da data da publicação
        ...
        $inserir = "INSERT INTO pedidoscontatos (id, status, data, nome, email, telefone, estado, cidade, assunto, texto) 
        ...
        if($acao -> rowCount()) {
             ...
             //=========== prepara corpo do e-mail =======================//
                //Compo E-mail
                       ...
                       <div class="main" style = "margin: auto; font-family: Arial; font-size: 16px; max-width: 500px; padding: 20px; min-width: 300px; border: 0px solid red;">
                        ...
                        <div class="corpo-mail" style = "width: 100%; margin-top: 20px; padding: 10px 0px; border-bottom: 0px solid #ccc; color: #909090;">
                          ...
                          <p style = "font-size: 18px;">
                            '.$nome.' gostaria de conversar sobre "'.$assunto.'". Esses são os dados dele(a):
                          </p>
                  ...
                  $assunto = "[ Contato | Prover Odonto ] ".$nome." deseja falar sobre ".$assunto;

                  //Este sempre deverá existir para garantir a exibição correta dos caracteres
                  $headers  = "MIME-Version: 1.0\n";
                  $headers .= "Content-type: text/html; charset=UTF-8\n";
                  $headers .= "De: $nome <relaciomento@proverodonto.com.br>";

                  //========== verifica se ouve o enviao no e-mail
