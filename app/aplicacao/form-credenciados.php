<?php
	...
	$nome = $_POST['NomeCredenciado'];
  $email = $_POST['EmailCredenciado'];
  $fone = $_POST['CelularCredenciado'];
	$cidade = $_POST['cidadeCredenciado'];  
  $estado = $_POST['estadoCredenciado'];  
  
  $tipoInscricao = $_POST['tipoCredenciado'];
	$especialidade = $_POST['especialidadeCredenciado'];
	$registro = $_POST['registroCredenciado'];
  $registroUF = $_POST['ufRegistroCredenciado'];
  ...
  function deixarNumero($string){
    return preg_replace("/[^0-9]/", "", $string);
        ...
        $inserir = "INSERT INTO pedidoscredenciados (id, status, data, nome, email, telefone, estado, cidade, tipo, especialidade, numeroCRO, ufCRO) 
                    VALUES ('$identificador', 'Não lido', '$data', '$nome', '$email', '$fone', '$estado', '$cidade', '$tipoInscricao', '$especialidade', '$registro', '$registroUF')";
        ...
        if($acao  -> rowCount()) {
                  ...
                  $arquivo = '
                       <div class="main" style = "margin: auto; font-family: Arial; font-size: 16px; max-width: 500px; padding: 20px; min-width: 300px; border: 0px solid red;">
                        ...
                        <div class="corpo-mail" style = "width: 100%; margin-top: 20px; padding: 10px 0px; border-bottom: 0px solid #ccc; color: #909090;">
                          <h1 style = "color: #2897cf"> Ajude '.$nome.' a ser um credenciado Prover Odonto!</h1>
                          <p style = "font-size: 18px;">
                            '.$nome.' gostaria de se um credenciado Prover Odonto. Esses são os dados dele(a):
                          </p>
                          <p style = "padding: 20px; margin: 10px; border-radius: 3px; background-color: #fafafa; border-left: 2px solid #2897cf;">
                            ...
                            <br><br>
                            <span style = "color: #c1c1c1;">Cidade de atendimento</span><br>
                            <span style = "font-size: 20px; color: #707070;">'.$cidade.' / '.$estado.'</span>
                            <br><br>

                            <span style = "color: #c1c1c1;">Tipo de inscrição</span><br>
                            <span style = "font-size: 20px; color: #707070;">'.$tipoInscricao.'</span>
                            <br><br>

                            <span style = "color: #c1c1c1;">Especialidade</span><br>
                            <span style = "font-size: 20px; color: #707070;">'.$especialidade.'</span>
                            <br><br>

                            <span style = "color: #c1c1c1;">Registro</span><br>
                            <span style = "font-size: 20px; color: #707070;">'.$registro.' / '.$registroUF.'</span>
                            <br><br>
                        ...
                        <div class="ropade-mail" style = " font-size: 13px; color: #909090; width: 100%; margin-top: 20px;  border-top: 1px solid #ccc; padding: 15px 0px;">
                          ...
                          <p>Formulario de origem<b> Credenciado</b>. <Br>
                  ...
                  $assunto = "[ Credenciamento | Prover Odonto ] ".$nome." quer ser um(a) credenciado(a) Prover Odonto ";
                    ...
                    if(mail($destino, $assunto, $arquivo, $headers)){
                      echo '
                          <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            Em breve a nossa Equipe de Credenciamento entrará em contato com você! Fique atento nos canais que você informou.
