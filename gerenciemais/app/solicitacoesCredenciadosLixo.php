...
<html lang="pt-br">
  <head>
    ...
    <title>Lixo | Solicitações de credenciamentos | Gerencie mais</title>
  </head>
  <body>
        ...
        <div class="container pt-3 pb-4">
            <div class="row">
                <div class="col-md fonte-20">
                    ...
                    <a href="<?= $URL_BASE ?>app/solicitacoesCredenciados.php?Acao=Listar" class = "links">Solicitações de credenciamentos</a>
                    <span class="material-icons-round icones">chevron_right</span>
                ...
                <div class="modal fade" id="modal_limpar_lixo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href = "solicitacoesCredenciadosLixo.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=LimparLixo&Status=LimparLixo" class="botao botao-vermelho-f">Excluir tudo</a>
                            </div>
                            </div>
                        </div>
                </div>
                            ...
                            <div class="col-md-1 text-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                        <li><a class="dropdown-item" href="solicitacoesCredenciadosPrevia.php?Acao=Visualizar&Rotativo=<?= $registo['id'] ?>&Status=AbertoLixeira"><span class="material-icons-round icones">description</span>Ver detalhes</a></li>
                                        
                                        <li><a class="dropdown-item" href = "solicitacoesCredenciadosLixo.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=Restaurar&Rotativo=<?= $registo['id'] ?>&Status=Restaurar"><span class="material-icons-round icones">auto_delete</span>Restaurar</a></li>
                                        ...
                                        <div class="modal fade" id="modal_lixo_<?= $registo['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="botao botao-nulo" data-bs-dismiss="modal">Cancelar</button>
                                                    <a href = "solicitacoesCredenciadosLixo.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=Excluir&Rotativo=<?= $registo['id'] ?>&Status=Excluir" class="botao botao-vermelho-f">Sim, eliminar</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <?php
        ...
        if (isset($_GET['novaAcao'])) {
            ...
            if ($acaoRecebida == "Excluir") {
                ...
                // echo "Ok! Vamos ocultar conteúdo";
                $selecionaAcao = "DELETE FROM pedidoscredenciados WHERE id = '$acoRotativo'";
                $consultaAcao = $conexao -> prepare($selecionaAcao);
                $consultaAcao -> execute();
            ...
            if ($acaoRecebida == "LimparLixo") {
                ...
                // echo "Ok! Vamos ocultar conteúdo";
                 $selecionaAcao = "DELETE FROM pedidoscredenciados WHERE status = 'Lixeira'";
                 $consultaAcao = $conexao -> prepare($selecionaAcao);
                 $consultaAcao -> execute();
