<?php
    ...
    if (isset($_GET['_novaAcao_ext'])) {
        ...
        if ($acaoRecebida == "Ocultar") {
            ...
            $selecionaAcao = "UPDATE ajuda SET status = 'Oculto' WHERE id = '$acoRotativo'";
        ...
        if ($acaoRecebida == "Desocultar") {
            ...
            $selecionaAcao = "UPDATE ajuda SET status = 'Publicado' WHERE id = '$acoRotativo'";
            $consultaAcao = $conexao -> prepare($selecionaAcao);
            $consultaAcao -> execute();
        ...
        if ($acaoRecebida == "Lixeira") {
             ...
             $selecionaAcao = "UPDATE ajuda SET status = 'Lixeira' WHERE id = '$acoRotativo'";
             $consultaAcao = $conexao -> prepare($selecionaAcao);
             $consultaAcao -> execute();
        ...
        if ($acaoRecebida == "Excluir") {
            ...
            // echo "Ok! Vamos ocultar conteúdo";
            $selecionaAcao = "DELETE FROM ajuda WHERE id = '$acoRotativo'";
            $consultaAcao = $conexao -> prepare($selecionaAcao);
            $consultaAcao -> execute();
