...
<html lang="pt-br">
  <head>
    ...
    <title>Prévia solicitações de credenciamentos | Gerencie mais</title>
  </head>
  <body>
...
if(isset($_GET['Rotativo'])){
    ...
    $seleciona = "SELECT * FROM pedidoscredenciados WHERE id = '$RotativoRecebido' ";
                ...
                while($registo = $consulta -> fetch(PDO::FETCH_ASSOC)){
                    ...
                    if(isset($_GET['Status'])){
                        ...
                        if($statusGet == 'MarcarLido'){
                            $altera = "UPDATE pedidoscredenciados SET status='Lido' WHERE id = '$RotativoRecebido'";
...
?>
            ...
            <div class="row mb-2">
                <div class="col-md">
                    <h5>Solicitação <?= $registo['nome'] ?></h5>  
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-12 col-md-12">
                    <div class="gm-box">
                            ...
                            <div class="col-md">
                                <div class="">
                                    ...
                                    <p class = "fonte-18 cor-preto">
                                        <?= $registo['numeroCRO'] ?> / <?= $registo['ufCRO'] ?>
                                    </p>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="">
                                    <p>Cidade(s) de atendimento(s)</p> 
                                    <p class = "fonte-18 cor-preto">
                                        <?= $registo['cidade'] ?> / <?= $registo['estado'] ?>
                                    </p>
                                    <!-- <p class = "mt-2 mb-2"><a href="http://maps.google.com.br/maps?q=proversaudedourados" class = "botao botao-cinza-m" target = "_blank"><span class="material-icons-round icones">location_on</span> Abrir mapa</a></p> -->
                                </div>
                            </div>
