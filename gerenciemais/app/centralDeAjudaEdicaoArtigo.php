<?php 
    include_once ('../aplicacao/configuracao.php'); 
     ...
     $_Rotativo_ext = $_GET['_Rotativo_ext'];
...
<html lang="pt-br">
  <head>
    ...
    <title>Editando artigo | Gerencie mais</title>
  </head>
  <body>
        ...
        <div class="container pt-3 pb-4">
            <div class="row">
                <div class="col-md fonte-20">
                    ...
                    <span class="material-icons-round icones">chevron_right</span>
                    <span class = "cor-preto-b">Editndo artigo</span>
                </div>
...
<?php
    ...
    if(!empty($recebeDados["enviar"])){
        ...
        $inserir = "UPDATE ajuda SET titulo='$titulo', conteudo='$conteudo' WHERE id='$_Rotativo_ext'";
...
?>
 ...
 <form action="" class = "gm-formularios" id = "profissionaisAdd" method = "post">
  ...
  $selecionaArtigo = "SELECT * FROM ajuda WHERE id = '$_Rotativo_ext' ";
                ...
                <div class="col-12 col-md-12">
                    <div class="box-form">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name = "titulo" class="form-control" id="f-campo" value = "<?= $registoArtigo['titulo'] ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <textarea id="summernote" name="conteudo" required><?= $registoArtigo['conteudo'] ?></textarea>
                            </div>
                        </div>
