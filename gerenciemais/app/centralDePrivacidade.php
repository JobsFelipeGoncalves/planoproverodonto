...
<html lang="pt-br">
  <head>    
    ...
    <title>Central de Privacidade | Gerencie mais</title>
  </head>
  <body>
        ...
        <div class="container pt-3 pb-4">
            <div class="row">
                <div class="col-md fonte-20">
                    ...
                    <span class = "cor-preto-b">Central de Privacidade</span>
                </div>
...
?>
        ...
        <div class="row mb-2 mt-2 pt-3 pb-2">
            <div class="col-md-3">
                <a href="centralDePrivacidadeAdd.php?Retorno=<?= $URL_ATUAL ?>&Acao=Novo&Status=Criando&Rotativo=<?php echo $idRotativo = rand(0000000000,9999999999); ?>" class = "botao botao-vermelho-f" title = "Clique para criar um novo conteúdo"> + Adicionar novo</a>
            </div>
            <div class="col-md-7"><!-- nulo --></div>
            <div class="col-md-2">
                <a href="centralDePrivacidadeLixo.php?Acao=Listar&Status=TodosDaLixeira" class = "botao botao-cinza" title = "Clique parar ver o que tem na lixeira"> <span class="material-icons-round icones">delete_sweep</span>Ver a lixeira</a>
            </div>
        </div>
