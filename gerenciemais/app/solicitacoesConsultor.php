...
<html lang="pt-br">
  <head>
    ...
    <title>Fale com um consultor | Gerencie mais</title>
  </head>
  <body>
        ...
        <div class="container pt-3 pb-4">
            <div class="row">
                <div class="col-md fonte-20">
                    ...
                    <span class = "cor-preto-b">Fale com um consultor</span>
                </div>
    ...
    <div class="container w-75 mb-3 mt-4">
        ...
        <div class="row mb-2 mt-2 pt-3 pb-2">
            ...
            <div class="col-md-3">
                <a href="solicitacoesConsultorLixo.php?Acao=Listar&Status=TodosDaLixeira" class = "botao botao-cinza" title = "Clique parar ver o que tem na lixeira"> <span class="material-icons-round icones">delete_sweep</span>Ver a lixeira</a>
            </div> 
        </div>
...
?>
                        <div class = "row listas-de-conteudo-item "> 
                            <div class="col-md-9">
                                <p class = "fonte-16"><b class = "cor-"><?= $registo['nome'] ?></b> solicitou ajuda com um consultor</p>
                            ...
                            <div class="col-md-1 text-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                        <li><a class="dropdown-item" href="solicitacoesConsultorPrevia.php?Acao=Visualizar&Rotativo=<?= $registo['id'] ?>&Status=MarcarLido"><span class="material-icons-round icones">description</span>Ver detalhes</a></li>
                                        ...
                                        <li><a class="dropdown-item" href = "solicitacoesConsultor.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=<?= $textoLink ?>&Rotativo=<?= $registo['id'] ?>&Status=<?= $textoLink ?>"><span class="material-icons-round icones"><?= $iconeVisivel ?></span> <?= $textoVisivel ?></a></li>
                                        ...
                                        <div class="modal fade" id="modal_lixo_<?= $registo['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href = "solicitacoesConsultor.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=Lixeira&Rotativo=<?= $registo['id'] ?>&Status=MoverLixeira" class="botao botao-vermelho-f">Mover para o lixo</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <?php
        ...
        if (isset($_GET['novaAcao'])) {
            ...
            if ($acaoRecebida == "MarcarLido") {
                ...
                $selecionaAcao = "UPDATE pedidosconsultor SET status = 'Lido' WHERE id = '$acoRotativo'";
            ...
            if ($acaoRecebida == "Lixeira") {
                 ...
                 // echo "Ok! Vamos ocultar conteúdo";
                 $selecionaAcao = "UPDATE pedidosconsultor SET status = 'Lixeira' WHERE id = '$acoRotativo'";
                 $consultaAcao = $conexao -> prepare($selecionaAcao);
                 $consultaAcao -> execute();
