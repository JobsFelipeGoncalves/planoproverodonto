...
?>
        ...
        <div class="row mb-2 mt-2 pt-3 pb-2">
            <div class="col-md-3">
                <a href="contas-de-acesso-ova-conta.php?Retorno=<?= $URL_ATUAL ?>" data-bs-toggle="modal" data-bs-target="#modal_nova_conta" class = "botao botao-vermelho-f" title = "Clique para criar um novo conteúdo"> + Adicionar novo</a>
