...
<html lang="pt-br">
  <head>    
    ...
    <title>Central de Privacidade > Lixeira | Gerencie mais</title>
  </head>
  <body>
        ...
        <div class="container pt-3 pb-4">
            <div class="row">
                <div class="col-md fonte-20">
                    ...
                    <a href="<?= $URL_BASE ?>app/centralDePrivacidade.php?Acao=Lista" class = "links">Central de Privacidade</a>
                    <span class="material-icons-round icones">chevron_right</span>
                ...
                <div class="modal fade" id="modal_limpar_lixo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href = "centralDePrivacidadeLixo.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=LimparLixo&Status=LimparLixo" class="botao botao-vermelho-f">Excluir tudo</a>
                        </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-1 text-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li><a class="dropdown-item" href="centralDePrivacidadeLixo.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=Restaurar&Rotativo=<?= $registo['id'] ?>&Status=Restaurar"><span class="material-icons-round icones">auto_delete</span> Restaurar</a></li>
                                        ...
                                        <div class="modal fade" id="modal_<?= $registo['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-body text-center pl-5 pr-5">
                                                        ...
                                                        <p class = "p-2">Ao clicar em <strong>"Sim, eliminar"</strong>, você estará excluindo permanentimente "<?= $registo['titulo'] ?>" do banco de dados e não poderá ser recuperado.</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="botao botao-nulo" data-bs-dismiss="modal">Cancelar</button>
                                                    <a href = "centralDePrivacidadeLixo.php?Retorno=<?= $URL_ATUAL ?>&novaAcao=Eliminar&Rotativo=<?= $registo['id'] ?>&Status=Eliminar" class="botao botao-vermelho-f">Sim, eliminar</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <?php
        ...
        if (isset($_GET['novaAcao'])) {
            ...
            if ($acaoRecebida == "Eliminar") {
                ...
                // echo "Ok! Vamos ocultar conteúdo";
                $selecionaAcao = "DELETE FROM privacidades WHERE id = '$acoRotativo'";
                $consultaAcao = $conexao -> prepare($selecionaAcao);
                $consultaAcao -> execute();
            ...
            if ($acaoRecebida == "LimparLixo") {
                ...
                // echo "Ok! Vamos ocultar conteúdo";
                $selecionaAcao = "DELETE FROM privacidades WHERE status = 'Lixeira'";
                $consultaAcao = $conexao -> prepare($selecionaAcao);
                $consultaAcao -> execute();
